      ...
      <div className="grids mt-[7vw] px-[3vw] flex max-sm:flex-col gap-[1.5vw] max-sm:gap-[4vw]">
        <div className="container w-[30vw] max-sm:w-[95vw] h-[26vw] max-sm:h-[60vw] border-2 border-white rounded-[5vw] rounded-tr-none relative">
          ...
          <div className="px-10 max-sm:px-5 flex flex-col gap-2">
            ...
            <p className="text-[#FFFBF9] max-sm:text-[4vw] max-sm:leading-[5vw] capitalize tracking-normal max-sm:mt-[2vw]">
              We work with agents to create custom websites with MLS integration
              and marketing solutions that enhance their brand.
            </p>
            <a className="links" href="">
              <h2 className="linkHead text-[#FFFBF9] max-sm:text-[4vw] max-sm:mt-[2vw]">
                GET STARTED{" "}
        ...
        <div className="container w-[30vw] max-sm:w-[95vw] h-[26vw] max-sm:h-[65vw] border-2 border-white rounded-[5vw] rounded-tr-none relative">
          ...
          <div className="px-10 max-sm:px-5 flex flex-col gap-2">
            ...
            <a className="links" href="">
              <h2 className="text-[#FFFBF9] max-sm:text-[4vw] max-sm:mt-[2vw]">
                GET STARTED{" "}
                <span className="linkArrow text-[#C29671]">
                  <i class="ri-arrow-right-up-line"></i>
                </span>
