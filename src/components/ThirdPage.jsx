...
function ThirdPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#151515] pt-[2vw]">
      <div className="p-8 px-[3vw] relative">
        <img
          className="w-full h-full object-cover rounded-[5vw]"
          src="/images/9598.webp"
          alt=""
        />
        <div className="w-full h-full bg-[#151515] absolute top-0 left-0 opacity-[25%]"></div>
        <div className="text-animation absolute top-[9vw] left-[8vw] text-[#FFFBF9] text-[7vw] leading-[7vw] tracking-tight">
          <h1>Perfect your</h1>
          <h1>property's</h1>
          <h1>presence with</h1>
          <h1>StudioLux</h1>
    ...
    absolute top-[30%] right-[20%] z-[20] flex justify-center items-center"
        >
