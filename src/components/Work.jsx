function Work() {
  ...
  const Box = ({ heading, largeHeading, context, linkTag, image, arrow }) => (
    <div className="w-[28vw] max-sm:w-[87vw] bg-[#151515] rounded-[4vw] max-sm:rounded-[8vw] transform transition-all 0.25s hover:-translate-y-5">
  ...
  const SecondBox = ({
    ...
    <div className="w-[43vw] max-sm:w-[87vw] bg-[#151515] rounded-[4vw] max-sm:rounded-[8vw] transform transition-all 0.25s hover:-translate-y-7">
      <h2 className="text-white text-[1vw] max-sm:text-[3.5vw] p-7 max-sm:p-3 max-sm:px-4 font-semibold tracking-wide max-sm:mt-[3vw]">
        {heading}
      </h2>
      <h3 className="text-[#C29671] text-[2.8vw] max-sm:text-[8vw] leading-[2.8vw] max-sm:leading-[8vw] italic px-8 max-sm:px-4 font-semibold tracking-wide">
  ...
  return (
    <div className="w-full min-h-screen max-sm:h-[420vh] bg-[#151515] pt-[7vw] px-[3vw]">
      <div className="wrapper w-full sm:w-full h-full sm:h-full relative">
        <img
        ...
        <div>
          ...
          <div className="absolute top-[3%] max-sm:top-[0.5%] left-[4%] w-[16.5vw] max-sm:w-[40vw] h-[3vw] max-sm:h-[10vw] border-2 border-black rounded-3xl flex items-center justify-center gap-2 px-3">
            ...
            <h3 className="font-semibold text-[18px] max-sm:text-[10px]">
              OUR LATEST WORK
            </h3>
          </div>
          ...
          <div className="absolute top-[19%] max-sm:top-[8%] left-[4%] max-sm:flex-col flex gap-4 max-sm:gap-[3vw]">
          ...
          <div className="absolute top-[56%] max-sm:top-[64.5%] left-[4%] flex gap-4 max-sm:flex-col max-sm:gap-[2.5vw]">
